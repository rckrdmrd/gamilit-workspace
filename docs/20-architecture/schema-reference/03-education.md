---
titulo: Schema 3 - educational_content
tipo: arquitectura
...
| Tabla | Proposito |
|-------|-----------|
| educational_content.educational_modules | Definicion de modulos educativos |
| educational_content.module_progress | Progreso por modulo |
| educational_content.exercises | Catalogo de ejercicios |
| educational_content.exercise_types | Tipos de ejercicio |
| educational_content.exercise_attempts | Intentos de ejercicios |
| educational_content.exercise_results | Resultados de ejercicios |
| educational_content.exercise_feedback | Feedback de ejercicios |
| educational_content.contents | Contenido educativo |
| educational_content.content_versions | Versionado de contenido |
| educational_content.content_categories | Categorias de contenido |
| educational_content.reading_assignments | Asignaciones de lectura |
| educational_content.spaced_repetition | Repeticion espaciada |
