...
## 🎯 Alcance MVP - Portal de Maestros

| Componente | MVP ✅ | Fase 3 ⏳ |
|-----------|--------|-----------|
| **Páginas Funcionales** | 10 páginas (US-PM-000 a US-PM-006) | Recursos, Comunicación |
| **Módulos Educativos** | Módulos 1-3 (15 ejercicios) | Módulos 4-5 (8 ejercicios) |
| **Gestión de Aulas** | Ver, organizar, monitorear | CRUD completo de aulas |
| **Calificación** | Vista de respuestas, auto-grading M1 | Grading manual avanzado |
| **Notas de Profesor** | - | US-PM-004b (Fase 3) |
| **Control de Estudiantes** | Vista y monitoreo | Bloqueo/suspensión (Fase 3) |

> **Nota sobre Módulos 4-5:** Los módulos de Literacidad Digital (M4) y Producción Textual (M5) están en desarrollo y requieren evaluación con IA o revisión manual. Los 15 ejercicios de M1-M3 están 100% funcionales con calificación automática.
...
## Capítulo 11.5: Funcionalidades en Desarrollo (Fase 3)

> **⏳ PRÓXIMAMENTE**
> Las siguientes funcionalidades están planificadas para futuras versiones del portal.

### 11.5.1 Notas del Profesor (US-PM-004b)

**Estado:** ⏳ Fase 3

**Descripción:** Sistema para crear y gestionar notas privadas sobre estudiantes.

**Funcionalidades planificadas:**
- Crear notas privadas sobre cada estudiante
- Formato de texto enriquecido
- Búsqueda y filtrado de notas
- Historial cronológico
- Solo visibles para el maestro (privadas)

**Workaround actual:** Puede usar un documento externo o notas en Excel para registrar observaciones sobre sus estudiantes hasta que esta funcionalidad esté disponible.

---

### 11.5.2 Bloqueo/Suspensión de Estudiantes (US-PM-006)

**Estado:** ⏳ Fase 3

**Descripción:** Capacidad de suspender temporalmente el acceso de un estudiante a la plataforma.

**Funcionalidades planificadas:**
- Suspender/reactivar estudiantes de su aula
- Registro de motivo de suspensión
- Notificación automática al estudiante
- Historial de suspensiones (auditoría)
- Solo sobre estudiantes de sus propias aulas

**Workaround actual:** Contacte al administrador del sistema si necesita restringir el acceso de un estudiante.

---

### 11.5.3 Módulos 4-5: Literacidad Digital y Producción Textual

**Estado:** ⏳ En Desarrollo

Los módulos 4 y 5 están diseñados pero requieren tecnología adicional:

| Módulo | Ejercicios | Razón del Retraso |
|--------|------------|-------------------|
| **Módulo 4: Literacidad Digital** | 5 ejercicios | Requiere IA para verificación de fuentes y análisis de imágenes |
| **Módulo 5: Producción Textual** | 3 ejercicios | Requiere evaluación manual o IA para producciones creativas |

**Mientras tanto:** Los 15 ejercicios de los módulos 1-3 están 100% funcionales con calificación automática.
