...
> Production credentials should be rotated after initial setup and stored in environment variables,
> NOT in version-controlled files. See `docs/20-architecture/AMBIENTES-DEV-PROD.md` for the secure credential management approach.

**Referencia Técnica - Incluido en Documentación de Entrega**

**Ubicación:** docs/99-delivery/2025-11-16-entrega-final/08-CREDENCIALES-Y-ACCESOS.md
