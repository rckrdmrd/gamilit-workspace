...
| **Sistema de Rangos** | 6 rangos Maya | - |
| **Gamificación** | ML Coins, Logros, Misiones | Multiplicadores ML avanzados |
| **Social** | Amigos, Gremios, Leaderboards | Duelos 1v1, Torneos |

### ✅ Disponible Ahora (MVP Completo)

**Aprendizaje:**
- ✅ Acceder a **15 ejercicios interactivos** en Módulos 1-3 (100% funcionales)
- ✅ Completar ejercicios con **15 mecánicas diferentes** de comprensión lectora
...
- ⏳ **Módulos 4-5** (8 ejercicios adicionales) - En desarrollo
...
```
[Espacio para screenshot de pantalla de Registro]

Captura debe mostrar:
- URL: /auth/register
- Formulario de registro con campos visibles
...
```
[Espacio para screenshot de pantalla de Login]
...
```
[Espacio para screenshot del Dashboard Principal]

Captura debe mostrar:
- URL: /student/dashboard
- Header con ML Coins, Rango y XP
- Stats Grid (4 tarjetas de estadísticas)
- Misiones Activas
- Progreso de Rango Maya
- Actividad Reciente
```
...
```
[Espacio para screenshot de Vista de Módulos]

Captura debe mostrar:
- URL: /student/modules
- Lista de los 5 módulos
- Estado de cada módulo (completado, en progreso, bloqueado)
- Porcentaje de avance por módulo
- Iconos temáticos Maya
```
...
#### 📚 Guía Pedagógica - Módulo 1

**Nivel Cassany:** Comprensión Literal (Nivel 1)

| # | Ejercicio | Objetivo Específico | Cómo se Evalúa |
|---|-----------|---------------------|----------------|
| **1.1** | Crucigrama Científico | Reconocer vocabulario científico (radioactividad, polonio, Nobel) | 100 pts ÷ 6 palabras = ~17 pts c/u |
| **1.2** | Línea de Tiempo | Ordenar 7 eventos cronológicos de la vida de Marie Curie (1867-1934) | 100 pts ÷ 7 eventos = ~14 pts c/u |
| **1.3** | Completar Espacios | Identificar datos biográficos específicos (nombres, lugares, fechas) | 100 pts ÷ 6 espacios = ~17 pts c/u |
| **1.4** | Verdadero o Falso | Verificar afirmaciones contra información explícita del texto | 100 pts ÷ 10 afirmaciones = 10 pts c/u |
| **1.5** | Sopa de Letras (BONUS) | Reforzar vocabulario científico en múltiples direcciones | Opcional: +100 XP bonus |

**Criterios de Aprobación:**
- Calificación mínima: **70/100 puntos** por ejercicio
- Penalización por comodín: **-15 ML Coins** por pista usada

**Consejos para el Estudiante:**
- Lee el texto completo antes de responder
- Presta atención a fechas y nombres propios
- En el crucigrama, usa las intersecciones como pistas
- En la línea de tiempo, identifica primero el evento más antiguo y el más reciente
...
**Nivel Cassany:** Comprensión Inferencial (Nivel 2)

| # | Ejercicio | Objetivo Específico | Cómo se Evalúa |
|---|-----------|---------------------|----------------|
| **2.1** | Detective Textual | Identificar inferencias de causa-efecto, contexto y motivación | 4 preguntas × 25 pts = 100 pts |
| **2.2** | Construcción de Hipótesis | Relacionar causas con múltiples consecuencias (emparejamiento) | 2 causas × 50 pts = 100 pts |
| **2.3** | Predicción Narrativa | Predecir resultados históricos basándose en contexto de época | Respuesta correcta = 100 pts |
| **2.4** | Puzzle de Contexto | Ordenar fragmentos para formar inferencia coherente | 4 fragmentos × 25 pts = 100 pts |
| **2.5** | Rueda de Inferencias | Generar respuestas en 4 categorías cognitivas (30 seg c/u) | Variable según categoría (20-30 pts) |

**Categorías de la Rueda:**
- **LITERAL** (20 pts): Información explícita del texto
- **INFERENCIAL** (25 pts): Deducciones lógicas
- **CRÍTICO** (30 pts): Juicios de valor fundamentados
- **CREATIVO** (25 pts): Conexiones personales originales

**Criterios de Aprobación:**
- Calificación mínima: **70/100 puntos** por ejercicio
- Tiempo límite por pregunta: **90 segundos** (Detective Textual)

**Consejos para el Estudiante:**
- Busca pistas textuales que sugieran sin decir directamente
- En predicciones, considera el contexto histórico de la época
- Distingue entre lo que dice el texto y lo que implica
- En la Rueda, responde rápido pero con sustancia (calidad > cantidad)
...
#### 📚 Guía Pedagógica - Módulo 3

**Nivel Cassany:** Comprensión Crítica y Valorativa (Nivel 3)

| # | Ejercicio | Objetivo Específico | Cómo se Evalúa |
|---|-----------|---------------------|----------------|
| **3.1** | Tribunal de Opiniones | Clasificar HECHO/OPINIÓN/INTERPRETACIÓN y evaluar fundamento | 8 afirmaciones × 12.5 pts |
| **3.2** | Debate Digital | Argumentar con evidencia específica en 4 fases (10 min) | Claridad + Evidencia + Lógica + Persuasión |
| **3.3** | Análisis de Fuentes | Evaluar 5 fuentes con método CRAAP | Ranking correcto = 90-100 pts |
| **3.4** | Podcast Argumentativo | Crear guion de 2 min con 3 argumentos | Estructura + Evidencia + Citas + Duración |
| **3.5** | Matriz de Perspectivas | Analizar desde 6 perspectivas diferentes | 6 perspectivas × 16.7 pts |

**Método CRAAP (Análisis de Fuentes):**
- **C**urrency: ¿Es información reciente?
- **R**elevance: ¿Es pertinente al tema?
- **A**uthority: ¿El autor es experto?
- **A**ccuracy: ¿Es verificable?
- **P**urpose: ¿Cuál es la intención?

**Criterios de Aprobación:**
- Calificación mínima: **75/100 puntos** (más alta que M1-M2)
- Requiere argumentación con evidencia específica

**Consejos para el Estudiante:**
- Distingue hechos verificables de opiniones subjetivas
- Respalda argumentos con evidencia (fechas, nombres, estadísticas)
- En el debate, reconoce puntos válidos del oponente
- Considera quién escribió, cuándo, y con qué propósito

---

### 3.1.5 Módulo 4: Literacidad Digital

> **⏳ BACKLOG - PRÓXIMAMENTE**
>
> Este módulo está **diseñado pero aún no implementado**. Estará disponible en una actualización futura.
> **Razón:** Los ejercicios de este módulo requieren tecnología de IA avanzada (verificación de fuentes, análisis de imágenes, procesamiento de video) que está en desarrollo.

**Estado:** ⏳ **En Backlog** (5 ejercicios planificados)
...
| # | Ejercicio | Tipo | Tecnología Requerida |
|---|-----------|------|----------------------|
| 4.1 | **Verificador de Fake News** | `verificador_fake_news` | APIs de fact-checking |
| 4.2 | **Infografía Interactiva** | `infografia_interactiva` | Visión computacional |
| 4.3 | **Quiz Estilo TikTok** | `quiz_tiktok` | Análisis de video/audio |
| 4.4 | **Navegación Hipertextual** | `navegacion_hipertextual` | Tracking de rutas |
| 4.5 | **Análisis de Memes** | `analisis_memes` | Comprensión multimodal |

**Objetivos de Aprendizaje (cuando esté disponible):**
...
Este módulo requiere infraestructura de Machine Learning que está siendo desarrollada. Se notificará a los usuarios cuando esté listo.
...
>
> Este módulo está **diseñado pero aún no implementado**. Estará disponible en una actualización futura.
> **Razón:** Los ejercicios de producción creativa requieren evaluación manual por profesores o evaluación con IA de contenido multimedia, que está en desarrollo.

**Estado:** ⏳ **En Backlog** (3 ejercicios planificados)

**Descripción:** Crear contenido efectivo - redactar textos, producir contenido multimedia, comunicar ideas claramente.

**Ejercicios Planificados:**

| # | Ejercicio | Tipo | Evaluación Requerida |
|---|-----------|------|----------------------|
| 5.1 | **Diario Interactivo de Marie** | `diario_multimedia` | Evaluación de creatividad narrativa |
| 5.2 | **Resumen Visual (Cómic Digital)** | `comic_digital` | Evaluación artística y narrativa |
| 5.3 | **Cápsula del Tiempo (Video Carta)** | `video_carta` | Análisis de video, audio y guion |

**Objetivos de Aprendizaje (cuando esté disponible):**
- Producir contenido original basado en aprendizaje
- Combinar texto y multimedia efectivamente
- Comunicar ideas de forma creativa
- Desarrollar habilidades de expresión
- Crear contenido en diferentes formatos digitales

**¿Cuándo estará disponible?**
Este módulo requiere un sistema de evaluación manual por profesores o evaluación con IA de producciones creativas. Se notificará cuando esté listo.
...
```
[Espacio para screenshot de Ejercicio en Progreso]

Captura debe mostrar:
- URL: /student/exercises/:id
- Título y módulo del ejercicio
- Instrucciones visibles
- Área de interacción del ejercicio
- Timer (si aplica)
- Botón de power-ups
- Barra de progreso
```
...
```
[Espacio para screenshot de Página de Logros]

Captura debe mostrar:
- URL: /student/achievements
- Categorías de logros (Progreso, Maestría, Social, Ocultos)
- Logros desbloqueados vs bloqueados
- Iconos de insignias
- Progreso de logros incrementales
...
```
[Espacio para screenshot de Leaderboard]

Captura debe mostrar:
- URL: /student/leaderboard
- Tabla de clasificación con posiciones
- Top 3 con badges especiales
- Tu posición resaltada
- Filtros de tipo (Global, Escuela, Grado, Amigos)
- Columnas: posición, avatar, nombre, rango, XP, tendencia
```
...
```
[Espacio para screenshot de Sistema de Rangos Maya]

Captura debe mostrar:
- URL: /student/gamification
- Tu rango Maya actual con insignia
- Barra de progreso de XP
- XP actual vs XP requerido para siguiente rango
- Lista de beneficios del rango actual
- Próximo rango y sus beneficios
```
...
```
[Espacio para screenshot de la Tienda]

Captura debe mostrar:
- URL: /student/shop
- Tu saldo de ML Coins
- Lista de power-ups disponibles
- Precios y descripciones
- Botones de compra
- Descuentos por rango (si aplica)
```
...
```
[Espacio para screenshot de Página de Amigos]

Captura debe mostrar:
- URL: /student/friends
- Lista de amigos confirmados
- Tabs: Mis Amigos, Solicitudes, Buscar, Actividades
- Estado online/offline de amigos
- Botones de acción (ver perfil, comparar)
```
...
Al probar el portal de estudiantes, tomar screenshots en los siguientes puntos:

| # | Ubicación | Descripción |
|---|-----------|-------------|
| 1 | `/auth/register` | Pantalla de registro con formulario |
| 2 | `/auth/login` | Pantalla de login |
| 3 | `/student/dashboard` | Dashboard principal con stats y misiones |
| 4 | `/student/modules` | Vista de módulos con progreso |
| 5 | `/student/exercises/:id` | Ejercicio en progreso |
| 6 | `/student/achievements` | Página de logros e insignias |
| 7 | `/student/leaderboard` | Tabla de clasificación |
| 8 | `/student/gamification` | Sistema de Rangos Maya |
| 9 | `/student/shop` | Tienda de power-ups |
| 10 | `/student/friends` | Página de amigos |

**Total: 10 screenshots para validación completa** ✅
...
- `docs/finiquito/Manual-Portal-Maestros-ACTUALIZADO.md`
- `docs/finiquito/Manual-Portal-Administrador-ACTUALIZADO.md`
