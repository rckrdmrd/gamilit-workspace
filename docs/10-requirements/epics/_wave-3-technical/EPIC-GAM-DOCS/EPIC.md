...
- docs/40-api/: API-REFERENCE (899 endpoints), ADMIN-PORTAL-ENDPOINTS
...
| Backend | BACKEND_INVENTORY.yml (22 modulos, 899 endpoints documentados), Swagger/OpenAPI |
| Frontend | FRONTEND_INVENTORY.yml (4 portales, 475 componentes documentados) |
| DevOps | N/A |
