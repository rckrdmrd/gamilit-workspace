---
titulo: "EPIC-GAM-DOCS: Documentacion Gamilit"
tipo: epic
...
- docs/40-api/: API-REFERENCE (914 endpoints), ADMIN-PORTAL-ENDPOINTS
...
| Backend | BACKEND_INVENTORY.yml (23 modulos, 914 endpoints documentados), Swagger/OpenAPI |
