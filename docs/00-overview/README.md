...
Esta seccion queda normalizada por temas atomicos.  
El `README.md` es solo puerta de entrada y evita duplicar definiciones SSOT.
...
- 1FN: un archivo por concepto principal.
- 2FN: cada archivo contiene solo contenido de su tema.
- 3FN: no se replica contenido canonico, se enlaza SSOT.

## Referencias

- [docs/README.md](../README.md)
- [docs/_MAP.md](../_MAP.md)
- [ESTANDAR-DOCUMENTACION.md](../40-standards/ESTANDAR-DOCUMENTACION.md)
