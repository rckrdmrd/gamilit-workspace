...
Este directorio se mantiene como puente para enlaces legacy.  
La navegacion canonica vive en `docs/README.md` y `docs/_MAP.md`.

## Documentos en esta carpeta

- [README-FASE-5.md](./README-FASE-5.md): resumen legacy de la fase final.
- [_MAP-FASE-5.md](./_MAP-FASE-5.md): mapa legacy de referencias.
