# MAPA DE NAVEGACION - Deployment

> Navegacion por tipo de operacion.
...
- GitHub Actions: [GUIA-GITHUB-ACTIONS-CICD.md](./GUIA-GITHUB-ACTIONS-CICD.md)
- Docker multistage: [GUIA-DOCKER-MULTISTAGE.md](./GUIA-DOCKER-MULTISTAGE.md)
- Pipeline migraciones: [GUIA-PIPELINE-MIGRACIONES.md](./GUIA-PIPELINE-MIGRACIONES.md)
