...
|-----------|-------------|
| [API-REFERENCE.md](API-REFERENCE.md) | 850 endpoints organizados por modulo |
| [ADMIN-PORTAL-ENDPOINTS.md](ADMIN-PORTAL-ENDPOINTS.md) | Implementacion detallada endpoints admin portal (P2) |
