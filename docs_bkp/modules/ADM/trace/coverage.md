...
| Métrica | Valor |
|---------|-------|
| Requerimientos Totales | 0 |
| Especificaciones Totales | 0 |
| Tests Totales | 0 |
| Objetos Totales (DB+BE+FE) | 12 |
|   - DB Objects | 4 |
|   - Backend Objects | 8 |
|   - Frontend Objects | 0 |
...
|------|------------|---------|
| REQ → SPEC | 0.0% | 0/0 requerimientos con especificación |
| REQ → TEST | 0.0% | 0/0 requerimientos con tests |
| REQ → OBJ | 0.0% | Requerimientos con objetos implementados |
