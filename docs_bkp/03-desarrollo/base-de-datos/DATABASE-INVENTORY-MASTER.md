...
- **Schemas:** 13
- **Tablas:** 62
- **Enums:** 35 definiciones (35 únicos, 0 duplicados)
- **Functions:** 60 (actualizado post-cleanup 2025-11-07)
- **Triggers:** 39 (actualizado post-cleanup 2025-11-07)
- **RLS Policies:** 18 archivos
- **Foreign Keys:** 94

### ✅ DUPLICADOS DETECTADOS: 0

**Última validación:** 2025-11-07
**Cleanup ejecutado:** 3 archivos duplicados eliminados
- 1 función duplicada eliminada (auth.get_current_user_id)
- 2 triggers duplicados eliminados (public schema)
