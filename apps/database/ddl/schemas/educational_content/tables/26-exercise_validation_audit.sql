-- ============================================================================
-- TABLA: exercise_validation_audits
...
CREATE TABLE educational_content.exercise_validation_audits (
    ...
    original_audit_id UUID REFERENCES educational_content.exercise_validation_audits(id) ON DELETE SET NULL,
...
ALTER TABLE educational_content.exercise_validation_audits
...
BEFORE UPDATE ON educational_content.exercise_validation_audits
FOR EACH ROW
...
COMMENT ON TABLE educational_content.exercise_validation_audits IS
...
COMMENT ON COLUMN educational_content.exercise_validation_audits.submitted_answer IS
...
COMMENT ON COLUMN educational_content.exercise_validation_audits.exercise_snapshot IS
...
COMMENT ON COLUMN educational_content.exercise_validation_audits.validation_config_snapshot IS
...
COMMENT ON COLUMN educational_content.exercise_validation_audits.is_recalculated IS
'Indica si este registro es resultado de un recálculo.
Si true, original_audit_id apunta al registro original.';

COMMENT ON COLUMN educational_content.exercise_validation_audits.has_discrepancy IS
...
GRANT SELECT, INSERT ON educational_content.exercise_validation_audits TO authenticated;

-- Los profesores pueden ver todas las auditorías y marcar discrepancias
GRANT SELECT, UPDATE ON educational_content.exercise_validation_audits TO admin_teacher;
