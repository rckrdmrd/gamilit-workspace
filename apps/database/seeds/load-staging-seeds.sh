...
execute_sql "$SEEDS_DIR/auth_management/03-profiles.sql" "Seeds: profiles"
execute_sql "$SEEDS_DIR/auth_management/04-user_roles.sql" "Seeds: user_roles"
...
execute_sql "$SEEDS_DIR/gamification_system/03-leaderboard_metadata.sql" "Seeds: leaderboard_metadata"
execute_sql "$SEEDS_DIR/gamification_system/04-maya_ranks.sql" "Seeds: maya_ranks"
execute_sql "$SEEDS_DIR/gamification_system/02-achievements.sql" "Seeds: achievements"
