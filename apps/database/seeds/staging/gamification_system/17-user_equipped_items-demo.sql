-- =====================================================
-- Seed: gamification_system.user_equipped_items (STAGING demo loadout)
-- Description: Equipamiento demo para validar aplicación de variantes al usuario
-- Environment: STAGING
-- Dependencies: 16-user_purchases-demo.sql
-- Order: 17
-- =====================================================
...
SELECT
    '17100000-0000-0000-0000-000000000001'::uuid,
    'cccccccc-cccc-cccc-cccc-cccccccccccc'::uuid,
    si.category_id,
    si.id,
    gamilit.now_mexico() - INTERVAL '12 hours',
    jsonb_build_object(
        'seed_source', '17-user_equipped_items-demo.sql',
...
SELECT
    '17100000-0000-0000-0000-000000000002'::uuid,
    'cccccccc-cccc-cccc-cccc-cccccccccccc'::uuid,
    si.category_id,
    si.id,
