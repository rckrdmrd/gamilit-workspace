-- =====================================================
-- Seed: gamification_system.user_purchases (STAGING demo ownership)
...
(
    '16100000-0000-0000-0000-000000000001'::uuid,
    ...
    true,
    jsonb_build_object(
        'seed_source', '16-user_purchases-demo.sql',
...
(
    '16100000-0000-0000-0000-000000000002'::uuid,
    'cccccccc-cccc-cccc-cccc-cccccccccccc'::uuid,
