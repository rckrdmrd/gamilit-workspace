...
execute_sql "$SEEDS_DIR/social_features/06-team_members.sql" "Seeds: team_members"
execute_sql "$SEEDS_DIR/social_features/07-friend_requests.sql" "Seeds: friend_requests"
execute_sql "$SEEDS_DIR/social_features/08-peer_challenges.sql" "Seeds: peer_challenges"
execute_sql "$SEEDS_DIR/social_features/09-challenge_participants.sql" "Seeds: challenge_participants"
execute_sql "$SEEDS_DIR/social_features/10-team_challenges.sql" "Seeds: team_challenges"
...
execute_sql "$SEEDS_DIR/progress_tracking/04-learning-paths.sql" "Seeds: learning_paths"
execute_sql "$SEEDS_DIR/progress_tracking/05-user-learning-paths.sql" "Seeds: user_learning_paths"
execute_sql "$SEEDS_DIR/progress_tracking/06-user-difficulty-progress.sql" "Seeds: user_difficulty_progress"
execute_sql "$SEEDS_DIR/progress_tracking/07-user-current-level.sql" "Seeds: user_current_level"
execute_sql "$SEEDS_DIR/progress_tracking/08-teacher-notes.sql" "Seeds: teacher_notes"
execute_sql "$SEEDS_DIR/progress_tracking/09-skill-assessments.sql" "Seeds: skill_assessments"
execute_sql "$SEEDS_DIR/progress_tracking/10-mastery-tracking.sql" "Seeds: mastery_tracking"
execute_sql "$SEEDS_DIR/progress_tracking/11-engagement-metrics.sql" "Seeds: engagement_metrics"
execute_sql "$SEEDS_DIR/progress_tracking/12-progress-snapshots.sql" "Seeds: progress_snapshots"
execute_sql "$SEEDS_DIR/progress_tracking/13-module-completion-tracking.sql" "Seeds: module_completion_tracking"
execute_sql "$SEEDS_DIR/progress_tracking/14-scheduled-missions.sql" "Seeds: scheduled_missions"
...
execute_sql "$SEEDS_DIR/lti_integration/02-lti_sessions.sql" "Seeds: lti_sessions"
execute_sql "$SEEDS_DIR/lti_integration/03-lti_grade_passback.sql" "Seeds: lti_grade_passback"
