...
INSERT INTO notifications.notification_templates (
    ...
    'rank_promoted',
    'Promoción de Rango',
    'Notificación cuando el estudiante sube de rango',
...
¡Sigue esforzándote para alcanzar el siguiente nivel!',
    NULL,
...
INSERT INTO notifications.notification_templates (
    ...
    'module_completed',
    'Módulo Completado',
    'Notificación cuando el estudiante completa un módulo',
    '🎓 ¡Módulo completado: {{module_name}}!',
...
INSERT INTO notifications.notification_templates (
    ...
    'challenge_received',
    'Desafío Recibido',
    'Notificación cuando un estudiante recibe un desafío',
    '⚔️ ¡{{challenger_name}} te ha desafiado!',
    'Hola {{student_name}},

{{challenger_name}} te ha enviado un desafío:
...
-- Template 12: Desafío completado
INSERT INTO notifications.notification_templates (
    template_key,
    name,
    description,
    ...
    'challenge_completed',
    'Desafío Completado',
    'Notificación cuando se completa un desafío',
    '🏅 ¡Desafío completado!',
...
• Módulos avanzados: {{modules_progress}}
• Ejercicios completados: {{exercises_completed}}
• XP totales ganados: {{total_xp}}

🏆 Posición en ranking: #{{ranking_position}}',
    NULL,
...
• Módulos completados: {{modules_completed}}
...
El equipo docente está disponible para ayudar.',
    NULL,
...
INSERT INTO notifications.notification_templates (
    ...
    'Alerta cuando el estudiante no ha ingresado en varios días',
    '¡Te extrañamos {{student_name}}! 📚',
    'Hola {{student_name}},

¡Te hemos extrañado! Han pasado {{days_inactive}} días desde tu última visita.

Tu racha actual: {{current_streak}} días (¡no la pierdas!)

Mientras estuviste fuera:
• Nuevos ejercicios disponibles: {{new_exercises}}
• Desafíos pendientes: {{pending_challenges}}

¡Regresa y continúa tu aventura de aprendizaje!',
    NULL,
...
-- Template 18: Ejercicio enviado (confirmación)
-- FIX GAP-MED-004: Agregado para confirmar envío de ejercicio a estudiante
INSERT INTO notifications.notification_templates (
    template_key,
    name,
    description,
    ...
    'exercise_submitted',
    'Ejercicio Enviado',
    'Confirmación de que el ejercicio fue enviado exitosamente',
...
Tu ejercicio requiere revisión manual por tu profesor. Te notificaremos cuando sea calificado.
{{else}}
Tu ejercicio ha sido calificado automáticamente:
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    <div style="padding: 20px; background: #f9f9f9;">
        ...
        <p style="color: #666;">Tu profesor revisará tu trabajo y te notificará cuando esté calificado.</p>
    </div>
...
COMMENT ON TABLE notifications.notification_templates IS 'Contiene 18 plantillas predefinidas para notificaciones del sistema (EXT-003 - Actualizado 2026-01-04)';
