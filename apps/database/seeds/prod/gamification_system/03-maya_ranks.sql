...
-- =====================================================
-- ORIGEN:
-- - Configuración migrada desde backend (ranks.service.ts líneas 62-108)
-- - Anteriormente hardcodeada en TypeScript
--
-- CAMBIOS RESPECTO AL BACKEND:
-- - Agregado xp_multiplier (progresión lógica 1.0 → 1.5)
-- - Agregado perks en formato JSONB para beneficios adicionales
-- - Agregado iconos y colores para UI
-- - Agregado next_rank para facilitar navegación de progresión
--
-- BENEFICIOS:
-- - Configuración actualizable sin deploy
-- - Funciones SQL pueden consultar directamente
-- - Flexibilidad para agregar nuevos rangos o modificar umbrales
-- - Sincronización con funciones: calculate_user_rank, update_user_rank, etc.
--
-- PRÓXIMOS PASOS:
-- - Actualizar backend para leer configuración desde DB
-- - Considerar deprecar RANK_CONFIG hardcodeado
-- =====================================================
