...
export interface PortalLayoutProps {
  ...
  onLogout?: () => void;
  resolveOrgName?: (name: string | undefined, platformName: string) => string | undefined;
}

/**
 * PortalLayout - Layout compartido con sidebar para Admin y Teacher
 *
 * Proporciona una estructura consistente con:
 * - Header gamificado con información del usuario
 * - Sidebar de navegación con secciones según portalType
 ...
 * @example
 * ```tsx
 * <PortalLayout portalType="admin" user={user} onLogout={handleLogout}>
 *   <AdminDashboard />
 * </PortalLayout>
 * ```
 */
export const PortalLayout = ({
  ...
  const resolvedOrganizationName = resolveOrgName
    ? resolveOrgName(organizationName, platformName)
    : organizationName;
