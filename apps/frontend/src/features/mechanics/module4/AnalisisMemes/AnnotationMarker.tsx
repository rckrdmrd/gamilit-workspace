...
export const AnnotationMarker: React.FC<{ annotation: MemeAnnotation }> = ({ annotation }) => (
  ...
  >
    <div className="relative group">
      ...
      <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 hidden group-hover:block w-48 bg-white p-3 rounded-lg shadow-lg border-2 border-detective-danger z-10">
