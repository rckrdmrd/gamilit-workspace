...
export const mockCompletarEspaciosExercises: CompletarEspaciosData[] = [
  {
    ...
    description:
      'Lee el texto y completa los espacios en blanco con las palabras correctas del banco de palabras. Módulo 1 - Ejercicio 4',
    difficulty: 'medio',
    estimatedTime: 360,
    ...
    scenarioText:
      'Marie Curie provenía de una familia polaca muy dedicada a la educación y las ciencias. Sus padres fueron grandes influencias en su desarrollo intelectual.',
