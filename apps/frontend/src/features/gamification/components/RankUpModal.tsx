  ...
  return (
    <Modal isOpen={true} onClose={onDismiss} showCloseButton={false} size="sm" className="bg-transparent shadow-none p-0">
      <div className="-mx-6 -my-4 flex items-center justify-center">
        ...
        <button
          onClick={onDismiss}
          className="rounded-lg bg-white/20 px-6 py-2 font-medium text-white transition-colors hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/50"
        >
          Continuar!
        </button>
        </div>
