 ...
 * Achievements API
 *
 * @deprecated REC-008 (2026-02-18): Migrated to gamificationApi. Zero runtime consumers. Safe to delete.
 * Use gamificationApi from @/services/api/gamification/gamificationAPI.ts instead.
