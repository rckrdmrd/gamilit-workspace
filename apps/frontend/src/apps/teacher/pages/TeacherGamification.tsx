    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg bg-detective-bg-secondary p-2 text-detective-text transition-colors hover:bg-opacity-80 disabled:opacity-50"
          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="rounded-lg bg-detective-bg-secondary p-2 text-detective-text transition-colors hover:bg-opacity-80"
              >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                value={bonusAmount}
                onChange={(e) => setBonusAmount(Number(e.target.value))}
                className="flex-1 rounded-lg border border-gray-300 px-4 py-2 text-center outline-none focus:border-detective-orange focus:ring-2 focus:ring-detective-orange focus:ring-opacity-50"
                min="1"
                max="1000"
                disabled={grantingBonus}
              />
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-gray-300 px-4 py-2 outline-none focus:border-detective-orange focus:ring-2 focus:ring-detective-orange focus:ring-opacity-50"
              rows={3}
              minLength={10}
              disabled={grantingBonus}
            />
