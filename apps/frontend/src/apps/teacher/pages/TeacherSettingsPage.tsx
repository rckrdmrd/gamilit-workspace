...
export default function TeacherSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      handleError(err, 'Error al guardar configuración');
      setSaveStatus('error');
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <DetectiveCard padding="sm">
              <nav className="space-y-1" aria-label="Secciones de configuracion">
          ...
          {/* Content Area */}
          <div className="lg:col-span-3" role="region" aria-label={`Configuracion de ${sections.find(s => s.id === activeSection)?.label || activeSection}`}>
