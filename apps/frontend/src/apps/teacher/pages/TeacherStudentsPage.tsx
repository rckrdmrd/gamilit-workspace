  ...
  const columns: Column<StudentExtended>[] = [
    {
      ...
      label: (
        <button
          ...
          aria-label={`Ordenar por nombre ${sortField === 'student_name' ? (sortDirection === 'asc' ? 'descendente' : 'ascendente') : 'ascendente'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          className="flex items-center transition-colors hover:text-detective-orange"
          aria-label={`Ordenar por puntuacion ${sortField === 'average_score' ? (sortDirection === 'asc' ? 'descendente' : 'ascendente') : 'ascendente'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          className="flex items-center transition-colors hover:text-detective-orange"
          aria-label={`Ordenar por completitud ${sortField === 'completion_rate' ? (sortDirection === 'asc' ? 'descendente' : 'ascendente') : 'ascendente'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          className="flex items-center transition-colors hover:text-detective-orange"
          aria-label={`Ordenar por ultima actividad ${sortField === 'last_active' ? (sortDirection === 'asc' ? 'descendente' : 'ascendente') : 'ascendente'}`}
        >
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-detective-bg to-detective-bg-secondary">
      <main className="detective-container py-8">
        ...
        {/* Stats */}
        <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4" role="region" aria-label="Estadisticas de estudiantes">
          <DetectiveCard>
