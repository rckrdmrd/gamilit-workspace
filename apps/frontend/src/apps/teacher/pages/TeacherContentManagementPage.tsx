...
export default function TeacherContentManagementPage() {
  ...
  const handleSave = async () => {
    try {
      ...
      handleError(err, 'Error al guardar contenido');
    }
  };
  ...
  const handleClone = async (item: TeacherContent) => {
    try {
      ...
      handleError(err, 'Error al clonar contenido');
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      handleError(err, 'Error al eliminar contenido');
    }
  };
  ...
  const handlePublish = async (item: TeacherContent) => {
    try {
      ...
      handleError(err, 'Error al publicar contenido');
    }
  };
