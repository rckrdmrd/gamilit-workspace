          ...
          >
            ...
            <div className="mb-3 flex items-start justify-between gap-2">
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 group-hover:text-detective-orange truncate" title={review.exercise?.title}>
            ...
            <div className="mb-3 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-gray-900 truncate text-sm" title={review.student?.name}>
