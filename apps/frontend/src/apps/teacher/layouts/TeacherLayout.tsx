...
/**
 * TeacherLayout - Layout con sidebar para la aplicación de Teacher
 *
 * Proporciona una estructura consistente con:
 * - Header gamificado con información del usuario
 * - Sidebar de navegación con secciones de Teacher
...
export const TeacherLayout: React.FC<TeacherLayoutProps> = ({
  ...
  const resolvedOrganizationName = organizationName ?? platformName;
