        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-detective-text md:text-3xl">Leaderboards</h1>
                {lastUpdated && (
              ...
              <motion.button
                ...
                className={cn(
                  ...
                  activeTab === tab.id
                    ...
                    : 'bg-gray-100 text-detective-text-secondary hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600',
                )}
              >
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h2 className="mb-1 text-2xl font-bold">Your Rank</h2>
                      ...
                      <div className="text-right">
                        <div className="mb-1 text-5xl font-bold">#{myRank}</div>
                ...
                >
                  <div className="border-b border-gray-200 p-6 dark:border-gray-700">
                    <h2 className="flex items-center gap-2 text-xl font-bold text-detective-text">
                      <Medal className="h-6 w-6 text-detective-gold" />
                      Top Players
                    </h2>
                  </div>
                    ...
                    <AnimatePresence mode="wait">
                      {currentLeaderboard.map((entry, index) => (
                        <motion.div
                          ...
                          className={cn(
                            'flex items-center gap-4 p-4 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50',
                            index < 3 &&
                        ...
                        >
                          ...
                          <div className="flex-shrink-0">
                            {entry.avatarUrl ? (
                              ...
                              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-detective-orange to-orange-600 font-bold text-white">
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="truncate font-semibold text-detective-text">
                              {entry.fullName}
                            </p>
                            {entry.mayaRank && (
                              <p className="text-sm text-detective-text-secondary">
              ...
              <aside className="hidden space-y-6 lg:block">
                ...
                <motion.div
                  ...
                  className="rounded-xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 p-6 dark:border-purple-800 dark:from-purple-900/20 dark:to-pink-900/20"
                >
                  ...
                  <ul className="space-y-2 text-sm text-detective-text-secondary">
                    <li className="flex items-start gap-2">
                      <ChevronUp className="mt-0.5 h-4 w-4 flex-shrink-0 text-purple-500" />
