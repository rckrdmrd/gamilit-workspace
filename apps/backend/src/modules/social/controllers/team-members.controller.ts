 ...
 * @status Endpoints usados desde Teacher Portal para gestion de equipos.
 *         Pendiente integracion en Student Portal (join/leave team).
 */
@ApiTags('Social - Team Members', 'social-admin')
