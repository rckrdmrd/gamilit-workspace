...
- Requisito origen: /docs/01-fase-alcance-inicial/casos-uso/UC-*.md
- Tipos compartidos: /docs/90-transversal/tipos-compartidos/
...
- API backend: /docs/90-transversal/apis/
...
2. **vs Documentación:**
   - vs /docs/01-fase-alcance-inicial/ (todos los requisitos implementados?)
   - vs /docs/90-transversal/ (API coincide con spec?)
