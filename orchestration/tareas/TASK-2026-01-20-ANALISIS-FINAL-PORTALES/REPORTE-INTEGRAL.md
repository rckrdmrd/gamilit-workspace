...
1.  **Prioridad P0 (Inmediato):**
    -   Implementar servicio de almacenamiento (S3/MinIO) para resolver GAP-EX-004 (M5 Multimedia).
    -   Conectar props de `xpEarned`/`mlCoinsEarned` en todos los ejercicios para resolver GAP-EX-013.

2.  **Prioridad P1 (Esta semana):**
    -   Depurar componentes no usados (`SubmitExerciseButton`, etc.) para limpiar el codebase.
    -   Implementar las gráficas de `TeacherProgressPage` según la nueva spec.

3.  **Prioridad P2 (Mantenimiento):**
    -   Continuar elevando la cobertura de seeds al 100%.
    -   Estandarizar DTOs de ejercicios M1.

---
**Firmado:** Trae AI
**Rol:** Ejecutor de Tareas / Auditor Técnico
