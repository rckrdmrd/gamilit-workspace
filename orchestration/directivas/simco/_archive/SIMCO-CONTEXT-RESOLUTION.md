...
```yaml
BUSCAR: "orchestration/CONTEXT-MAP.yml"
...
L3_TAREA (DINÁMICO):
  segun_keywords:
    tabla:
      - "apps/database/ddl/schemas/{schema}/tables/{tabla}.sql"
    ...
    componente:
      ...
      - "apps/frontend/src/components/{similar}/*.tsx"
    endpoint:
...
KEYWORDS_CONTEXT_MAP:
  ...
  "tabla":
    ...
    contexto:
      ...
      - "apps/database/ddl/schemas/{schema}/tables/*.sql" (similar)
...
**Versión:** 1.0.1 | **Sistema:** SIMCO-NEXUS v4.1 | **Tipo:** Directiva de Resolución
