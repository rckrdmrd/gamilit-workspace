...
- **Schemas:** 13
- **Tablas:** 62
- **Enums:** 60 definiciones (53 únicos)
- **Functions:** 61
- **Triggers:** 49
- **RLS Policies:** 18 archivos
- **Foreign Keys:** 94

### ⚠️ DUPLICADOS DETECTADOS: 24

🟡 **ENUM:** `progress_status` - 2 instancias
🟡 **ENUM:** `media_type` - 2 instancias
🟡 **ENUM:** `audit_action` - 2 instancias
🟡 **ENUM:** `setting_type` - 2 instancias
🟡 **ENUM:** `notification_priority` - 3 instancias
🟡 **ENUM:** `alert_severity` - 2 instancias
🟡 **ENUM:** `alert_status` - 2 instancias
🟡 **ENUM:** `processing_status` - 2 instancias
🟡 **ENUM:** `notification_type` - 2 instancias
🟡 **ENUM:** `classroom_role` - 2 instancias
🟡 **ENUM:** `team_role` - 2 instancias
🟡 **ENUM:** `attempt_status` - 2 instancias
🟡 **ENUM:** `log_level` - 2 instancias
🟡 **ENUM:** `friendship_status` - 2 instancias
🟡 **ENUM:** `content_status` - 2 instancias
🟡 **ENUM:** `achievement_category` - 2 instancias
🟡 **ENUM:** `achievement_type` - 2 instancias
🟡 **ENUM:** `comodin_type` - 2 instancias
🟡 **ENUM:** `auth_provider` - 2 instancias
🟡 **ENUM:** `user_status` - 2 instancias
🟡 **ENUM:** `difficulty_level` - 2 instancias
🟡 **ENUM:** `cognitive_level` - 2 instancias
🟡 **ENUM:** `exercise_type` - 2 instancias
🔴 **ENUM:** `gamilit_role` - 2 instancias
...
**Definiciones:**
- `apps/database/ddl/schemas/auth_management/tables/05-auth_providers.sql:14`
...
**Definiciones:**
- `apps/database/ddl/schemas/educational_content/enums/cognitive_level.sql:8`
...
**Definiciones:**
- `apps/database/ddl/schemas/educational_content/enums/difficulty_level.sql:28`
...
**Definiciones:**
- `apps/database/ddl/schemas/gamification_system/enums/comodin_type.sql:23`
...
**Definiciones:**
- `apps/database/ddl/schemas/gamification_system/enums/notification_priority.sql:23`
...
**Definiciones:**
- `apps/database/ddl/schemas/progress_tracking/enums/progress_status.sql:12`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/alert_severity.sql:6`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/alert_status.sql:7`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/attempt_status.sql:7`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/audit_action.sql:7`

---

### `public.classroom_role`

**Propósito:** Sin descripción

**Definiciones:**
- `apps/database/ddl/schemas/public/enums/classroom_role.sql:6`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/content_status.sql:6`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/friendship_status.sql:8`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/log_level.sql:7`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/media_type.sql:6`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/notification_priority.sql:7`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/processing_status.sql:8`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/setting_type.sql:7`
...
**Definiciones:**
- `apps/database/ddl/schemas/public/enums/team_role.sql:9`
