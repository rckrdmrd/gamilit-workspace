...
5. **DOCUMENTAR DESARROLLO**: Todo lo implementado se documenta en `/docs/95-guias-desarrollo/`
6. **ACTUALIZAR PLANIFICACIÓN**: Todo progreso se refleja en `/docs/planning/`

### Rutas de Documentación

```
/home/isem/workspace/workspace-gamilit/gamilit/projects/gamilit/docs/
├── 01-fase-alcance-inicial/        # Validar ANTES de implementar
├── 90-transversal/  # Validar DURANTE implementación
├── 95-guias-desarrollo/            # Actualizar DESPUÉS de implementar
└── planning/         # Actualizar SIEMPRE con progreso
```
...
- [ ] Implementación alineada con /docs/01-fase-alcance-inicial/
- [ ] Implementación alineada con /docs/90-transversal/
...
**DV-001:** Validar contra `/docs/01-fase-alcance-inicial/` ANTES de implementar
**DV-002:** Validar contra `/docs/90-transversal/` DURANTE implementación
**DV-003:** Validar coherencia entre capas DESPUÉS de implementar
