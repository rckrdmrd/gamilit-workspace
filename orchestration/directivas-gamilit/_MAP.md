...
- Actualización de `/docs/95-guias-desarrollo/` y `/docs/planning/`
...
**Obligaciones:**
- ✅ Validar ANTES contra `/docs/01-fase-alcance-inicial/` y `/docs/90-transversal/`
- ✅ Validar DURANTE contra specs técnicas
- ✅ Validar DESPUÉS y actualizar `/docs/95-guias-desarrollo/` y `/docs/planning/`
